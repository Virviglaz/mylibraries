...
//					<3=> 0 dBm
//		</h>	
#define RFW_CONFIG_REG					47
#define RFW_SETUP_AW_REG				3
#define RFW_RF_CH_REG						53
#define RFW_RF_SETUP_REG				14
...
//		</h>
#define RFW_TX_ADDR_REG "BALON"
#define RFW_RX_ADDR_P0_REG "BALON"
